                ...
                Section::make('Jadwal Ujian')
                    ...
                    ->schema([
                        ...
                        FileUpload::make('file')
                            ->label('File Proposal')
                            ->disk('public')
                            ->directory(fn($get, $record) => UploadPathHelper::uploadTaPath($get, $record, 'ta-skripsi'))
                            ->acceptedFileTypes([
                                'application/pdf',
                                'application/msword',
                ...
                Section::make('Penilaian Dosen Pembimbing')
                    ...
                    ->schema([
                        ...
                        FileUpload::make('file_revisi_dosen_1')
                            ...
                            ->disk('public')
                            ->directory(fn($get, $record) => UploadPathHelper::uploadTaPath($get, $record, 'ta-skripsi-revisi'))
                            ->visible(fn($record) => self::isVisibleForSlot($record, 1))
                            ->disabled(
                                fn($record) =>
