...
class TaSeminarProposalForm
{
    public static function configure(Schema $schema): Schema
    {
        return $schema
            ->columns(1)
            ->components([
                Section::make('Status Seminar Proposal')
                    ->compact()
                    ->schema([
                ...
                Tabs::make('Form Seminar Proposal')
                    ->tabs([
                                ...
                                Section::make('Jadwal Ujian')
                                    ...
                                    ->schema([
                                        ...
                                        FileUpload::make('file')
                                            ->label('File Proposal')
                                            ->disk('public')
                                            ->directory(fn($get, $record) => UploadPathHelper::uploadTaPath($get, $get, 'ta-seminar-proposal'))
                                            ->acceptedFileTypes([
                                                'application/pdf',
                                                'application/msword',
                                ...
                                Section::make('Dokumen Pendukung')
                                    ...
                                    ->schema([
                                        FileUpload::make('file_kwitansi')
                                            ...
                                            ->disk('public')
                                            ->directory(fn($get, $record) => UploadPathHelper::uploadTaPath($get, $get, 'ta-seminar-proposal/kwitansi'))
                                            ->multiple()
                                            ->openable()
                                            ->downloadable(),
                                        FileUpload::make('file_surat')
                                            ...
                                            ->disk('public')
                                            ->directory(fn($get, $record) => UploadPathHelper::uploadTaPath($get, $get, 'ta-seminar-proposal/surat'))
                                            ->multiple()
                                            ->openable()
                                            ->downloadable(),
                                        FileUpload::make('file_plagiasi')
                                            ...
                                            ->disk('public')
                                            ->directory(fn($get, $record) => UploadPathHelper::uploadTaPath($get, $get, 'ta-seminar-proposal/plagiasi'))
                                            ->multiple()
                                            ->openable()
                                            ->downloadable(),
                                    ]),
                                ...
                                Section::make('Penilaian Dosen Pembimbing')
                                    ...
                                    ->schema([
                                        ...
                                        FileUpload::make('file_revisi_1')
                                            ...
                                            ->disk('public')
                                            ->directory(fn($get, $record) => UploadPathHelper::uploadTaPath($get, $get, 'ta-seminar-proposal-revisi'))
                                            ->visible(fn($record) => self::isVisibleForSlot($record, 1))
                                            ->multiple()
                                            ->disabled(
                                                fn($record) =>
                                        ...
                                        RichEditor::make('ctt_revisi_dosen_1')
                                            ...
                                            ->fileAttachmentsDirectory(fn($get, $record) => UploadPathHelper::uploadTaPath($get, $get, 'ta-seminar-proposal-revisi'))
