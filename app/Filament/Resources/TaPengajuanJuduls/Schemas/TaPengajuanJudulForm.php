    ...
    public static function configure(Schema $schema): Schema
    {
        return $schema
            ...
            ->components([
                ...
                // ── REVIEWER & UJIAN ─────────────────────────────────────────
                Section::make('Reviewer & Jadwal Ujian')
                    ->columns(2)
                    ->schema([
                        Select::make('id_dosen_review')
                            ->label('Dosen Reviewer')
                ...
                Section::make('Penilaian Dosen Pembimbing')
                    ...
                    ->schema([
                        ...
                        FileUpload::make('file_revisi_dosen_1')->label('File Revisi Dosen 1')->disk('public')->directory('ta/revisi'),
                        FileUpload::make('file_revisi_dosen_2')->label('File Revisi Dosen 2')->disk('public')->directory('ta/revisi'),
                        FileUpload::make('file_revisi_dosen_3')->label('File Revisi Dosen 3')->disk('public')->directory('ta/revisi'),

                        Textarea::make('ctt_revisi_dosen_1')->label('Catatan Revisi Dosen 1')->rows(2),
                        Textarea::make('ctt_revisi_dosen_2')->label('Catatan Revisi Dosen 2')->rows(2),
                        Textarea::make('ctt_revisi_dosen_3')->label('Catatan Revisi Dosen 3')->rows(2),
                    ]),
            ]);
    }
}
