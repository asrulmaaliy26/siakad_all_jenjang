...
<head>
    <meta charset="UTF-8">
    <title>Kartu Bimbingan Pengajuan Judul - {{ $ta->riwayatPendidikan?->siswa?->nama }}</title>
    <style>
        @page {
            margin: 0.5cm;
        }
...
<body>
    ...
    <div class="card-section {{ ($idx + 1 == $totalP) ? 'last-page' : '' }}">
        ...
        <div class="doc-title">KARTU BIMBINGAN SEMINAR PROPOSAL</div>
        ...
        <table class="info-table">
            ...
            <tr>
                <td class="info-label">Usulan Judul</td>
                <td>{{ $ta->judul }}</td>
            </tr>
            <tr>
