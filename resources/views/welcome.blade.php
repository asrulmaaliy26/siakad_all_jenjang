...
<body class="bg-[#FDFDFC] dark:bg-[#0a0a0a] text-[#1b1b18] flex p-6 lg:p-8 items-center lg:justify-center min-h-screen flex-col">
    ...
    <div class="flex items-center justify-center w-full transition-opacity opacity-100 duration-750 lg:grow starting:opacity-0">
        <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row items-center justify-center">
            <div class="text-[13px] leading-[20px] flex-1 p-6 pb-12 lg:p-20 bg-white dark:bg-[#161615] dark:text-[#EDEDEC] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d] rounded-bl-lg rounded-br-lg lg:rounded-tl-lg lg:rounded-br-none">
                <img src="{{ asset('logokampus.jpg') }}" alt="Logo Kampus" class="h-20 w-auto mb-6 rounded-lg shadow-md mx-auto lg:mx-0">
                <h1 class="mb-2 text-2xl font-bold text-gray-900 dark:text-white text-center lg:text-left text-balance">Selamat Datang di SIAKAD</h1>
                <p class="mb-6 text-[#706f6c] dark:text-[#A1A09A] text-base text-center lg:text-left text-balance">Sistem Informasi Akademik Terintegrasi. <br>Silakan login untuk mengakses layanan akademik anda.</p>

                <ul class="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                    <li>
                        <a href="{{ route('login') }}" class="inline-block dark:bg-lime-600 dark:border-lime-600 dark:text-white dark:hover:bg-lime-500 hover:bg-gray-800 hover:border-gray-800 px-8 py-2.5 bg-lime-700 rounded-md border border-lime-700 text-white font-semibold text-sm transition-all shadow-sm text-center w-full sm:w-auto">
                            Masuk Ke Sistem
                        </a>
                    </li>
                    @if (Route::has('register'))
                    <li>
                        <a href="{{ route('register') }}" class="inline-block px-8 py-2.5 rounded-md border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 font-semibold text-sm hover:bg-gray-50 dark:hover:bg-gray-800 transition-all text-center w-full sm:w-auto">
                            Daftar
                        </a>
                    </li>
                    @endif
            ...
            <div class="bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-slate-900 dark:to-slate-800 relative lg:-ml-px -mb-px lg:mb-0 rounded-t-lg lg:rounded-t-none lg:rounded-r-lg aspect-[335/376] lg:aspect-auto w-full lg:w-[438px] shrink-0 overflow-hidden flex items-center justify-center p-12 border border-gray-100 dark:border-gray-800 shadow-xl">
                <div class="text-center z-10">
                    <img src="{{ asset('logokampus.jpg') }}" alt="Siakad Banner" class="w-56 h-56 object-cover rounded-full shadow-2xl border-8 border-white dark:border-gray-700 mb-8 drop-shadow-2xl mx-auto ring-8 ring-lime-500/10">
                    <h2 class="text-2xl font-black text-slate-800 dark:text-white tracking-tight">UNGGUL & BERDIKARI</h2>
                    <p class="text-sm tracking-[0.2em] text-slate-500 dark:text-slate-400 uppercase font-bold mt-2">Portal Akademik</p>
                </div>
                <div class="absolute inset-0 opacity-20">
                    <img src="{{ asset('logokampus.jpg') }}" class="w-full h-full object-cover blur-3xl scale-150 rotate-12" alt="">
                </div>
