...
return new class extends Migration {
    public function up(): void {
        ...
        Schema::create('ta_skripsi', function (Blueprint $table) {
            $table->id();
            ...
            $table->date('tgl_acc_skripsi')->nullable()->default(null);
            $table->string('file', 255)->nullable()->default(null);
            $table->string('file_ppt', 255)->nullable()->default(null);
            ...
            $table->string('file_ktm', 255)->nullable()->default(null);
            $table->string('file_khs', 255)->nullable()->default(null);
            $table->string('file_kartu_bimbingan', 255)->nullable()->default(null);
            $table->string('file_sertifikat', 255)->nullable()->default(null);
            $table->string('file_quisioner', 255)->nullable()->default(null);
            $table->string('file_lampiran', 255)->nullable()->default(null);
            ...
            $table->decimal('nilai_akhir', 5, 2)->nullable()->default(null);
    ...
    public function down(): void { Schema::dropIfExists('ta_skripsi'); } 
};
