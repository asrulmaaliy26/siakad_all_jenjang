...
return new class extends Migration {
    public function up(): void {
        ...
        Schema::create('ta_pengajuan_judul', function (Blueprint $table) {
            $table->id();
            ...
            $table->enum('status_dosen_1', ['pending','setuju','ditolak','revisi'])->nullable()->default('pending');
            $table->enum('status_dosen_2', ['pending','setuju','ditolak','revisi'])->nullable()->default('pending');
            $table->enum('status_dosen_3', ['pending','setuju','ditolak','revisi'])->nullable()->default('pending');
            ...
            $table->string('file_revisi_dosen_1', 255)->nullable()->default(null);
            $table->string('file_revisi_dosen_2', 255)->nullable()->default(null);
            $table->string('file_revisi_dosen_3', 255)->nullable()->default(null);
    ...
    public function down(): void { Schema::dropIfExists('ta_pengajuan_judul'); } 
};
