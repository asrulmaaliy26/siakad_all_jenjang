...
<body>
    <div class="card">
        ...
        <div class="info-box">
            ...
            <div class="value"><?php echo e($mpk->mataPelajaranKurikulum?->mataPelajaranMaster?->nama ?? '-'); ?></div>

            <div class="label">Jenis Ujian</div>
            <div class="value"><?php echo e(strtoupper($type)); ?></div>

            <div class="label">Jumlah Pelanggaran</div>
            <div class="value" style="color:#ef4444">
                <?php echo e($ljk->{$type === 'uas' ? 'jml_pelanggaran_uas' : 'jml_pelanggaran_uts'} ?? 5); ?>x pelanggaran
            </div>
        </div>
        ...
        <a href="<?php echo e(url('/pekan-ujians/1')); ?>" class="back-btn">← Kembali ke Dashboard</a>
    </div>
</body>
</html>
<?php /**PATH C:\Users\losts\Desktop\web STAI AL Mannan\siakad\resources\views/ujian/blocked.blade.php ENDPATH**/ ?>