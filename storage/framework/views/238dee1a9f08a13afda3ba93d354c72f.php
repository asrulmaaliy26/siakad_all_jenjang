...
<head>
    ...
    <title>Ujian <?php echo e(strtoupper($type)); ?> – <?php echo e($mpk->mataPelajaranKurikulum?->mataPelajaranMaster?->nama); ?></title>
    <style>
...
<div id="topbar">
    <div class="info">
        <span class="badge">UJIAN <?php echo e(strtoupper($type)); ?></span>
        <div>
            <div class="matkul"><?php echo e($mpk->mataPelajaranKurikulum?->mataPelajaranMaster?->nama ?? 'Mata Pelajaran'); ?></div>
            <div class="meta"><?php echo e($mpk->dosenData?->nama ?? '-'); ?> &bull; Kelas <?php echo e($mpk->kelas?->semester); ?></div>
        </div>
    </div>
    <div class="right">
        <div id="violation-badge">
            ⚠️ <span id="vcount"><?php echo e($jmlPelanggaran); ?></span>/3 pelanggaran
        </div>
...
<div id="main">
    ...
    <div id="soal-panel">
        <div class="panel-header">
            📄 Soal <?php echo e(strtoupper($type)); ?>
        ...
        <div class="panel-content">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($fileUrl): ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array($fileExt, ['jpg','jpeg','png','gif','webp'])): ?>
                    <div style="display:flex;align-items:center;justify-content:center;height:100%;padding:20px;background:#0f172a;">
                        <img src="<?php echo e($fileUrl); ?>" alt="Soal" style="max-width:100%;max-height:100%;object-fit:contain;border-radius:8px;box-shadow:0 0 30px rgba(0,0,0,.5);">
                    </div>
                <?php elseif(in_array($fileExt, ['pdf'])): ?>
                    <iframe id="soal-frame" src="<?php echo e($fileUrl); ?>#toolbar=0&navpanes=0&scrollbar=1" title="Soal Ujian"></iframe>
                <?php elseif(in_array($fileExt, ['doc','docx'])): ?>
                    <iframe id="soal-frame" src="https://docs.google.com/viewer?url=<?php echo e(urlencode($fileUrl)); ?>&embedded=true" title="Soal Ujian"></iframe>
                <?php else: ?>
                    <div style="display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;color:#64748b;gap:16px;">
                        ...
                        <a href="<?php echo e($fileUrl); ?>" target="_blank" style="color:#3b82f6;">Unduh File Soal</a>
                    </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            <?php elseif($soalNote): ?>
                <div id="soal-note"><?php echo $soalNote; ?></div>
            <?php else: ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($fileUrl && $soalNote): ?>
        <div style="border-top:1px solid #1e293b;background:#1e293b;padding:16px 20px;max-height:180px;overflow:auto;flex-shrink:0;">
            ...
            <div style="font-size:13px;color:#cbd5e1;line-height:1.7;"><?php echo $soalNote; ?></div>
        </div>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    </div>
    ...
    <div id="jawaban-panel">
        <div class="panel-header">
            ✏️ Input Jawaban <?php echo e(strtoupper($type)); ?>

        </div>
        <div class="panel-content">
            <form id="jawaban-form" action="<?php echo e(route('ujian.submit', [$mpk->id, $type])); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($savedFiles)): ?>
                <label class="field-label">📂 File Jawaban Tersimpan</label>
                <div id="saved-files">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $savedFiles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $f): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e(asset('storage/'.$f)); ?>" target="_blank" class="saved-file-item">
                        📄 <?php echo e(basename($f)); ?> <span style="margin-left:auto;font-size:10px;opacity:.7">↗ Buka</span>
                    </a>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

                <label class="field-label" style="margin-top:<?php echo e(!empty($savedFiles) ? '20px' : '0'); ?>; display: flex; align-items: center; justify-content: space-between;">
                    <span>📎 Upload File Jawaban (LJK <?php echo e(strtoupper($type)); ?>)</span>
                ...
                <input type="file" id="file-input" name="<?php echo e($ljkField); ?>[]" multiple
                ...
                <div id="editor-container" contenteditable="true" style="min-height:200px; padding:14px; border:1px solid #334155; border-radius:0 0 10px 10px; background:#0f172a; color:#e2e8f0; outline:none; overflow-y:auto; user-select:text; -webkit-user-select:text;"><?php echo $savedCtt; ?></div>
                <input type="hidden" id="ctt-jawaban" name="<?php echo e($cttField); ?>" value="<?php echo e($savedCtt); ?>">
...
<script>
// ═══════════════════ CONFIG ═══════════════════
const LJK_ID          = <?php echo e($ljk->id); ?>;
const EXAM_TYPE       = '<?php echo e($type); ?>';
const MAX_PELANGGARAN = 3;
const CSRF_TOKEN      = document.querySelector('meta[name="csrf-token"]').content;

// ─── State ───
let violationCount   = <?php echo e($jmlPelanggaran); ?>;
let isBlocked        = <?php echo e(($ljk->cekal_kuliah ?? 'N') === 'Y' ? 'true' : 'false'); ?>;
...
async function triggerViolation(keterangan) {
    ...
    // Kirim ke server
    try {
        const res = await fetch('<?php echo e(route('ujian.pelanggaran')); ?>', {
            method: 'POST',
            headers: {
...
<?php /**PATH C:\Users\losts\Desktop\web STAI AL Mannan\siakad\resources\views/ujian/fullscreen.blade.php ENDPATH**/ ?>